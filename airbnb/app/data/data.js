export const rooms = [
  {
    id: 1,
    title:
      "New Open Marita m01, right in front of the beach, couple pension, quiet village, near Gwakji, Hyeopjae",
    property_type: "All",
    max_capacity: 2,
    bedrooms: 1,
    beds: 1,
  ...
  {
    id: 2,
    title: "Jeju Sweet Lodge Mini Mary",
  ...
  {
    id: 3,
    title: "New studio near Shinjeju central airport (standard)",
    property_type: "Whole house",
    max_capacity: 3,
    bedrooms: 1,
    beds: 2,
  ...
  {
    id: 4,
    title: "A house in the middle of a tangerine field",
    property_type: "Whole house",
    max_capacity: 2,
    bedrooms: 1,
    beds: 2,
  ...
  {
    id: 5,
    title: "Ju's home(2) 9km from the airport/ Gamseong accommodation on the 2nd floor in front of the beach in Jeju City",
