  ...
  return (
    <Container>
      ...
      <Main>
        ...
        <Checkin>
          <View>
            <Typography.Cap color={colors.gray}>Available from</Typography.Cap>
            <Typography.Sub1>{trip.check_in_date}</Typography.Sub1>
          </View>
          <View>
            <Typography.Cap color={colors.gray}>Available to</Typography.Cap>
        ...
        <Host>
          <List.UserList
            title="Hosted by Stian Grimsrud"
            subtitle="Joined in December 2018"
        ...
        <Rules>
          <View>
            <Typography.Cap color={colors.gray}>Rules</Typography.Cap>
