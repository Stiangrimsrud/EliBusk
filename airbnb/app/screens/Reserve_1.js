    ...
    <Container>
      <Detail>
        <MainWrapper>
          ...
          <Flex>
            <View>
              <Typogrpahy.Cap color={colors.gray}>Available from</Typogrpahy.Cap>
              <Typogrpahy.Sub1>{props.state.startDay}</Typogrpahy.Sub1>
            </View>
            <View>
              <Typogrpahy.Cap color={colors.gray}>Available to</Typogrpahy.Cap>
              <Typogrpahy.Sub1>{props.state.endDay}</Typogrpahy.Sub1>
            </View>
            <View>
              <Typogrpahy.Cap color={colors.gray}>Cars</Typogrpahy.Cap>
          ...
          <View>
            ...
            <Flex>
              <Typogrpahy.Sub1>
                ${listing.price} x {calcNights()}Foil
              </Typogrpahy.Sub1>
            ...
            <HLine />
            <Flex>
              <Typogrpahy.Sub1>Sum</Typogrpahy.Sub1>
      ...
      <Reserve>
        <Button.BtnContain label="Make reservation" color={colors.red} />
        {/* Send action */}
      </Reserve>
    </Container>
  );
